...
// Type row sesuai struktur CSV/database
type DataRow = {
  id: number;
  date: string;
  enodeb_name: string;
      ...
      <div className="flex flex-wrap gap-3 mb-4 items-end">
        ...
        <div className="flex flex-col">
          ...
          <select
            ...
            className={`px-3 py-2 rounded-lg border focus:ring-2 focus:ring-purple-500 ${theme === "dark" ? "bg-gray-900/80 text-white border-transparent" : "bg-white text-gray-900 border-gray-200"}`}
          >
        ...
        <button
          onClick={resetFilter}
          className={`rounded-lg px-3 py-2 text-sm font-medium hover:bg-gray-900 transition ml-2 mt-4 md:mt-0 ${theme === "dark" ? "bg-gray-700 text-white" : "bg-gray-300 text-gray-800 hover:bg-gray-500"}`}
          type="button"
        >
          Reset
        </button>
